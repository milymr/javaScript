...
let resultado4 = idade <= 18 // menor lou igual
...
let situação = total > 0 
console.log (situação)
console.log("outro exemplo")   // saber se um número é divisivel por outro
let numero = 10 % 2 // vai dar 0 // 10 / 2 = 5 sobra nada
